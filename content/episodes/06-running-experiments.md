...
| 2 | `big_mlp` | Large MLP baseline (~50K params, no physics) |
| 3 | `transformer` | Attention-based baseline (~50K params, no physics) |
...
- **Architecture matters most**: the 12-param student beats 50K-param baselines regardless of hyperparameters
