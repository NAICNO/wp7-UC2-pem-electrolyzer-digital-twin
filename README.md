...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19184217.svg)](https://doi.org/10.5281/zenodo.19184217)
...
> **Key finding**: A 12-parameter physics-informed student model outperforms ~530K-parameter pure ML models on out-of-distribution data, achieving ~15 mV OOD MAE through knowledge distillation from a hybrid teacher.
...
| Model | Params | Val MAE | Test2 (Current) | Test3 (Pressure) | OOD Avg |
|-------|--------|---------|-----------------|-------------------|---------|
| Distilled Student | 12 | ~14 mV | ~15 mV | ~16 mV | ~15 mV |
| Teacher (HybridPhysicsMLP) | ~9,354 | ~14 mV | ~43 mV | ~14 mV | ~28 mV |
| Pure Physics | 12 | ~25 mV | ~18 mV | ~23 mV | ~21 mV |
| PureMLP | ~2,049 | ~13 mV | ~45 mV | ~38 mV | ~42 mV |
| BigMLP | ~43,393 | ~12 mV | ~52 mV | ~42 mV | ~47 mV |
| Transformer | ~529,793 | ~10 mV | ~68 mV | ~55 mV | ~62 mV |
...
```bash
tmux new-session -d -s training 'cd ~/wp7-UC2-pem-electrolyzer-digital-twin && \
  source venv/bin/activate && \
  python scripts/pem_electrolyzer/main.py --mode full --device cuda --epochs 100 \
